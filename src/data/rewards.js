...
export const REWARDS = [
  ...
  },
  {
    ...
    description: 'SubZero or La Diperie. Whatever mix-ins you want.',
    cost: 150,
    tier: 'low',
    icon: 'icecream',
    hue: 340,
  ...
  {
    id: 'ubereats-30',
    title: 'Uber Eats · $30 Order',
    description: 'Order what you want up to $30. Fees included.',
    cost: 300,
    tier: 'low',
    icon: 'moped',
    hue: 96,
  ...
  {
    id: 'ubereats-40',
    title: 'Uber Eats · $40 Order',
    description: 'A $40 ceiling. Enough for two mains and a side.',
    cost: 420,
    tier: 'medium',
    icon: 'moped',
    hue: 84,
  ...
  {
    id: 'ubereats-50',
    title: 'Uber Eats · $50 Order',
    description: 'The big one. $50, dessert included.',
    cost: 550,
    tier: 'medium',
    icon: 'moped',
    hue: 72,
  ...
  },
  {
    id: 'skincare-haul',
    title: 'Skincare Haul',
    description: 'Serums, masks, the whole routine. $60 to restock.',
    cost: 750,
    tier: 'medium',
    icon: 'serum',
    hue: 328,
  },
  {
    ...
    description: 'Shein, Uniqlo, wherever. $75 on a new fit.',
    cost: 900,
    tier: 'medium',
    icon: 'shirt',
    hue: 300,
  },
  {
    id: 'shoes-shopping',
    title: 'New Shoes',
    description: 'One pair, your pick. Up to $120.',
    cost: 1300,
    tier: 'medium',
    icon: 'shoe',
    hue: 254,
